...
public class CommandLine {
    ...
    public static void printHelp() {
        System.out.println(
                """
                        Roster Generator for Github Classroom. Reads an Excel file with students generated by SIES (https://sies.uniovi.es/serviciosdocentes),
                        and generates a roster file with the students ids, optionally filtered by groups.

                        Usage: java -jar roster.jar [<sies.xls>] [-g <groups_file>] [-o <output_file>]
